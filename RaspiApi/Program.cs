...
builder.Services.AddSingleton<IEndpointIdentifier, EndpointIdentifier>();
builder.Services.AddSingleton<IRaspberryConnector, RaspberryConnector>();
//builder.Services.AddSingleton<ClockBackgroundService>();
...
app.MapHub<MessageHub>("/set");
app.MapCustomerEndpoints(builder.Services);
